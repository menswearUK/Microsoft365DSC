function Get-TargetResource
{
    ...
    try
    {
        ...
        $getValue = $null
        #region resource generator code
        $getValue = Get-MgDeviceAppMgtPolicySet -PolicySetId $Id  -ErrorAction SilentlyContinue
        ...
        if ($null -eq $getValue)
        {
            ...
            {
                $getValue = Get-MgDeviceAppMgtPolicySet `
...
function Set-TargetResource
{
    ...
    elseif ($Ensure -eq 'Absent' -and $currentInstance.Ensure -eq 'Present')
    {
        ...
        #region resource generator code
Remove-MgDeviceAppMgtPolicySet -PolicySetId $currentInstance.Id
        #endregion
    }
}
...
function Export-TargetResource
{
    ...
    {
        #region resource generator code
        [array]$getValue = Get-MgDeviceAppMgtPolicySet `
            -All `
            -ErrorAction Stop
        #endregion
